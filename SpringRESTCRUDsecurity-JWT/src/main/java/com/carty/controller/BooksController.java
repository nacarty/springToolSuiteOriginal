...
@RestController
@RequestMapping("${myrequestmapping}") //This can be "/api" or ${myrequestmapping} because I created a custom property in my application.properties file. All of the mappings below are prefixed with the prefix "/api". 
